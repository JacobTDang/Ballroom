...
Output: 700
Explanation: The optimal path with at most 1 stop from city 0 to 3 has
cost 100 + 600 = 700.
```
...
Output: 200
Explanation: The optimal path with at most 1 stop from city 0 to 2 has
cost 100 + 100 = 200.
```
...
Output: 500
Explanation: The optimal path with no stops from city 0 to 2 has cost 500.
```
