...
**Note:** You must not use any built-in library for handling large
integers (such as `BigInteger`) directly, and you must not convert
the inputs directly into integers.
