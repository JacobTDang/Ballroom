...
Explanation: Another possible itinerary is ["JFK","SFO","ATL","JFK","ATL","SFO"]
but it is larger lexically.
```
...
- `from_i != to_i`
- It is guaranteed that a valid itinerary exists that uses all the given
