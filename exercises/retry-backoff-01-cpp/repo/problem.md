...
API: `bool Retry(std::function<bool()> op, int max_attempts, long base_ms, long cap_ms, std::function<void(long)> sleep)` — `op` returns success; Retry returns whether it ever succeeded.
